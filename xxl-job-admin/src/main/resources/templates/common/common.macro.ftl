		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["XXL_CONF_LOGIN_IDENTITY"].permission == 1>
					<li class="nav-click <#if pageName == "jobuser">active</#if>" ><a href="${request.contextPath}/jobuser"><i class="fa fa-circle-o text-grey"></i><span>用户管理</span></a></li>
				</#if>
